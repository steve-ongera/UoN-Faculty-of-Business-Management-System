...
urlpatterns = [
    ...
    path('chatbot/conversation/<uuid:conversation_id>/', views.chatbot_get_conversation, name='get_conversation'),
    ...
    path('chatbot/rate-message/', views.chatbot_rate_message, name='rate_message'),
    path('chatbot/submit-feedback/', views.chatbot_submit_feedback, name='submit_feedback'),
